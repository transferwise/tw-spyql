...
// The only difference is in setupSpyql method and absence of proxy related tests.
// Please keep this test in sync.
// !!!!!!!!!!!!!!!
class ObservableListenerIntTest extends Specification {
	...
	def setupSpyql(boolean attachListener = true) {
		...
		if (attachListener) {
			...
			proxy = new SpyqlDataSourceProxy(dataSourceMock, observableListener)
